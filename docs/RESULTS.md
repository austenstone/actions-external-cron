...
Observation window: **2026-08-19 22:00 → 2026-09-24 06:00 UTC** (849 hourly slots, 814 runs).
...
| --- | --- | --- | --- | --- | --- | --- |
| `github-schedule` | 814 | 94.7% | 8m 47.0s | 17m 56.0s | 29m 59.0s | 0 |
...
<sub>Generated 2026-09-24T06:42:43.929Z by `scripts/leaderboard.mjs`. Runs drifting more than 30 minutes are excluded — their slot cannot be inferred reliably.</sub>
