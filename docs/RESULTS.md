...
Observation window: **2026-08-19 22:00 → 2026-09-06 06:00 UTC** (417 hourly slots, 382 runs).
...
| --- | --- | --- | --- | --- | --- | --- |
| `github-schedule` | 382 | 89.2% | 8m 46.0s | 18m 35.0s | 29m 59.0s | 0 |
...
<sub>Generated 2026-09-06T06:36:38.401Z by `scripts/leaderboard.mjs`. Runs drifting more than 30 minutes are excluded — their slot cannot be inferred reliably.</sub>
