...
Observation window: **2026-08-19 22:00 → 2026-09-11 06:00 UTC** (537 hourly slots, 502 runs).
...
| --- | --- | --- | --- | --- | --- | --- |
| `github-schedule` | 502 | 91.6% | 8m 47.0s | 18m 13.0s | 29m 59.0s | 0 |
...
<sub>Generated 2026-09-11T06:40:05.721Z by `scripts/leaderboard.mjs`. Runs drifting more than 30 minutes are excluded — their slot cannot be inferred reliably.</sub>
