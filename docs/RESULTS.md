...
Observation window: **2026-08-19 22:00 → 2026-09-02 06:00 UTC** (321 hourly slots, 287 runs).
...
| --- | --- | --- | --- | --- | --- | --- |
| `github-schedule` | 287 | 86.6% | 8m 48.0s | 19m 11.0s | 29m 59.0s | 0 |
...
<sub>Generated 2026-09-02T06:45:18.595Z by `scripts/leaderboard.mjs`. Runs drifting more than 30 minutes are excluded — their slot cannot be inferred reliably.</sub>
