...
Observation window: **2026-08-19 22:00 → 2026-09-08 06:00 UTC** (465 hourly slots, 430 runs).
...
| --- | --- | --- | --- | --- | --- | --- |
| `github-schedule` | 430 | 90.3% | 8m 46.0s | 18m 35.0s | 29m 59.0s | 0 |
...
<sub>Generated 2026-09-08T06:40:22.215Z by `scripts/leaderboard.mjs`. Runs drifting more than 30 minutes are excluded — their slot cannot be inferred reliably.</sub>
